...
const en: Dict = {
  ...
  drawUndo: "Undo point",
  drawClear: "Clear",
  drawHint: "Click to add points; use the buttons to finish",
  inverse: "Inverse",
...
const fr: Dict = {
  ...
  drawClear: "Effacer",
  drawHint: "Cliquez pour ajouter des points ; utilisez les boutons pour terminer",
  inverse: "Inverse",
