...
const en: Dict = {
  ...
  effDelay: "Delay",
  effFade: "Fade",
  effLtr: "Left-to-right",
  effLtrHint: "Banner scroll direction: checked = left-to-right, unchecked = right-to-left",
  effY1: "Y1",
  effY2: "Y2",
...
const fr: Dict = {
  ...
  effDelay: "Délai",
  effFade: "Fondu",
  effLtr: "Gauche vers droite",
  effLtrHint: "Sens de défilement du bandeau : coché = gauche vers droite, décoché = droite vers gauche",
  effY1: "Y1",
  effY2: "Y2",
  marginsLabel: "Marges",
...
const ja: Dict = {
  ...
  effFade: "フェード",
  effLtr: "左から右",
  effLtrHint: "バナーのスクロール方向：チェック=左から右、未チェック=右から左",
  effY1: "Y1",
  effY2: "Y2",
  marginsLabel: "余白",
  noAlign: "配置なし",
